...
public class EmailServiceImpl implements EmailService {
    ...
    private static final String EMAIL_SIMPLE_TEMPLATE_NAME = "html/email";
    private static final String EMAIL_WITHATTACHMENT_TEMPLATE_NAME ="html/email";
     ...
     */
    /* (non-Javadoc)
	 * @see com.nagarro.testrunner.service.EmailService#sendTextMail(java.lang.String, java.lang.String, java.util.Locale)
	 */
    @Override
     ...
     */
    /* (non-Javadoc)
	 * @see com.nagarro.testrunner.service.EmailService#sendSimpleMail(java.lang.String, java.lang.String)
	 */
    @Override
	public  void sendSimpleMail(
        ...
        message.setFrom("himanshu.bansal@nagarro.com");
        message.setTo(recipientEmail);
     ...
     */
    /* (non-Javadoc)
	 * @see com.nagarro.testrunner.service.EmailService#sendMailWithAttachment(java.lang.String, java.lang.String, java.lang.String, byte[], java.lang.String, java.util.Locale)
	 */
    @Override
	public void sendMailWithAttachment(
	      final String[] emails, final String fileLocation,final String content,final String htmlFromReport,final byte[] imageBytes)
	                throws MessagingException {
                   String   imageResourceName="BarChart";
	                // Prepare the evaluation context
	                final Context ctx = new Context();
        ...
        // Add the attachment
        final InputStreamSource attachmentSource = new ByteArrayResource(htmlFromReport.getBytes());
        message.addAttachment(
            "TestReport.html", attachmentSource, "text/html");
        DataSource source = new FileDataSource(fileLocation);
        message.addAttachment(source.getName(), source);
        
        final InputStreamSource imageSource = new ByteArrayResource(imageBytes);
        message.addInline(imageResourceName, imageSource, "image/jpeg");
     ...
     */
    /* (non-Javadoc)
	 * @see com.nagarro.testrunner.service.EmailService#sendMailWithInline(java.lang.String, java.lang.String, java.lang.String, byte[], java.lang.String, java.util.Locale)
	 */
    @Override
     ...
     */
    /* (non-Javadoc)
	 * @see com.nagarro.testrunner.service.EmailService#sendEditableMail(java.lang.String, java.lang.String, java.lang.String, java.util.Locale)
	 */
    @Override
