...
public class SignupServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String emailid = request.getParameter(Constants.Email.getName());
		if (Util.userOperation.addUser(username, password, emailid)) {
			response.sendRedirect(Constants.LoginPagePath.getName());
		} else {
			System.out.println("User already exists");
			response.sendRedirect(Constants.SignupPagePath.getName());
		}
